"""Fail-closed construction provider used for disabled and future adapters."""
...
class UnavailableConstructionProvider:
    """Return normalized failures without retaining or contacting credentials."""

    adapter_version = "unavailable-construction-v1"
...
__all__ = ["UnavailableConstructionProvider"]
