...
PUBLIC_PRODUCT_TRANSLATIONS = {
    ...
    "prod_ports_visual_inspection": _copy(
        "Inspeção Visual Portuária e Industrial",
        ...
        "Ports & Industrial Visual Inspection",
        ...
        "Inspección Visual Portuaria e Industrial",
        "Evidencia RGB georreferenciada de un activo y zona exactos; los cambios cartografiados siguen siendo candidatos a revisión, sin conclusiones automáticas de defecto, seguridad o cumplimiento.",
        "Inspection Visuelle Portuaire et Industrielle",
        "Preuves RGB géoréférencées d’un actif et d’une zone précis ; les changements cartographiés restent à examiner, sans conclusion automatique de défaut, de sécurité ou de conformité.",
    ),
    "prod_ports_thermal_inspection": _copy(
        "Inspeção Térmica Portuária e Industrial",
        ...
        "Ports & Industrial Thermal Inspection",
        ...
        "Inspección Térmica Portuaria e Industrial",
        ...
        "Inspection Thermique Portuaire et Industrielle",
    ...
    "prod_ports_3d_mapping": _copy(
        "Captura de Realidade 3D Portuária e Industrial",
        ...
        "Ports & Industrial 3D Reality Capture",
        ...
        "Captura de Realidad 3D Portuaria e Industrial",
        ...
        "Capture de Réalité 3D Portuaire et Industrielle",
    ...
    "prod_ports_sensor_installation": _copy(
        "Instalação de Sensores Portuários e Industriais",
        ...
        "Ports & Industrial Sensor Installation",
        ...
        "Instalación de Sensores Portuarios e Industriales",
        "Instalación y asignación auditable de sensores a un activo GeoVision, sujetas a validar la ubicación, calibración, energía, conectividad y puesta en servicio.",
        "Installation de Capteurs Portuaires et Industriels",
    ...
    "prod_ports_monitoring_plan": _copy(
        "Plano de Monitorização Portuária e Industrial",
        ...
        "Ports & Industrial Monitoring Plan",
        ...
        "Plan de Monitorización Portuaria e Industrial",
        ...
        "Plan de Suivi Portuaire et Industriel",
    ...
    "prod_ports_specialist_review": _copy(
        "Revisão Especializada Portuária e Industrial",
        ...
        "Ports & Industrial Specialist Review",
        ...
        "Revisión Especializada Portuaria e Industrial",
        ...
        "Examen Spécialisé Portuaire et Industriel",
...
_SERVICE_PRODUCT_IDS = {
    ...
    "prod_ports_visual_inspection", "prod_ports_thermal_inspection",
    "prod_ports_3d_mapping", "prod_ports_sensor_installation",
    "prod_ports_monitoring_plan", "prod_ports_specialist_review",
