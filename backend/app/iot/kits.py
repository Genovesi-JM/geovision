...
SOLUTION_KITS: list[dict] = [
    {
        ...
        "diy_bom": [
            ...
            {
                "part": "SHT31 temp/humidity probe",
                "role": "temperature+humidity",
                "est_usd": 12,
            },
            {"part": "Reed switch", "role": "door contact", "est_usd": 3},
            {
                "part": "SCT-013 current clamp",
                "role": "compressor run-status",
                "est_usd": 10,
            },
        ...
        "channels": [
            ...
            },
            {
                "key": "door_open",
                "label": "Door",
                "measurement_type": "door_contact",
                "unit": None,
                "data_type": "boolean",
            },
            {
                "key": "compressor_run",
                "label": "Compressor run",
                "measurement_type": "run_status",
                "unit": None,
                "data_type": "boolean",
            },
            {
    ...
    },
    {
        ...
        "diy_bom": [
            {"part": "ESP32 dev board", "role": "controller", "est_usd": 15},
            {
                "part": "HC-SR04 / JSN-SR04T ultrasonic",
                "role": "tank level",
                "est_usd": 8,
            },
            ...
            {
                "part": "Low-voltage relay module",
                "role": "safe pump signal",
                "est_usd": 5,
            },
            {"part": "IP65 enclosure + glands", "role": "protection", "est_usd": 15},
        ],
    ...
    },
    {
        ...
        "diy_bom": [
            {"part": "ESP32 dev board", "role": "controller", "est_usd": 15},
            {
                "part": "PZEM-004T v3 module",
                "role": "voltage/current/power/energy",
                "est_usd": 12,
            },
    ...
    },
    {
        ...
        "diy_bom": [
            {"part": "ESP32 dev board", "role": "controller", "est_usd": 15},
            {
                "part": "Capacitive soil-moisture probe",
                "role": "soil moisture",
                "est_usd": 6,
            },
            ...
            {
                "part": "6V solar panel + 18650 + charger",
                "role": "off-grid power",
                "est_usd": 30,
            },
            {
                "part": "12V solenoid valve + driver",
                "role": "irrigation control",
                "est_usd": 20,
            },
            {
                "part": "IP65 enclosure + mast bracket",
                "role": "protection",
                "est_usd": 20,
            },
        ],
    ...
    },
    {
        ...
        "diy_bom": [
            {"part": "ESP32 dev board", "role": "controller", "est_usd": 15},
            {
                "part": "u-blox NEO-6M / NEO-M8N GPS module",
                "role": "gps",
                "est_usd": 12,
            },
            ...
            {
                "part": "IP65 enclosure + active GPS antenna",
                "role": "protection",
                "est_usd": 18,
            },
        ],
    ...
    },
    {
        ...
        "diy_bom": [
            ...
            {
                "part": "Solar radiation / light sensor",
                "role": "irradiance",
                "est_usd": 15,
            },
            {
        ...
        "channels": [
            ...
            },
            {
                ...
                "measurement_type": "solar_irradiance",
                "unit": "W/m2",
                "data_type": "number",
                "minimum": 0,
                "maximum": 1500,
        ...
        "alert_rules": [
            ...
            {
                "name": "Strong wind (suspend spraying)",
                "channel": "wind_speed",
                "operator": "gt",
                "threshold": 12,
                "severity": "warning",
    ...
    },
    {
        ...
        "alert_rules": [
            {
                "name": "Greenhouse over-temperature",
                "channel": "temperature",
                "operator": "gt",
                "threshold": 35,
                "severity": "warning",
    ...
    },
    {
        ...
        "diy_bom": [
            ...
            {
                "part": "Pressure transducer (0–10 bar)",
                "role": "line pressure",
                "est_usd": 18,
            },
            ...
            {
                "part": "Low-voltage relay module",
                "role": "pump/section signal",
                "est_usd": 5,
            },
            {
                "part": "Chemical-safe IP67 enclosure",
                "role": "protection",
                "est_usd": 20,
            },
        ],
    ...
    },
    {
        ...
        "diy_bom": [
            ...
            {
                "part": "Optical seed-flow sensor",
                "role": "seed flow / blockage",
                "est_usd": 15,
            },
        ...
        "alert_rules": [
            {
                "name": "Hopper low",
                "channel": "hopper_weight",
                "operator": "lt",
                "threshold": 10,
                "severity": "warning",
            },
            {
                "name": "Seed-line blockage",
                "channel": "blockage",
                "operator": "eq",
                "threshold": 1,
                "severity": "critical",
    ...
    },
    {
        ...
        "alert_rules": [
            {
                "name": "Low input stock",
                "channel": "stock_weight",
                "operator": "lt",
                "threshold": 10,
                "severity": "warning",
            },
...
_PUBLIC_SECTORS_BY_INDUSTRY = {
    "agriculture": ["agriculture"],
    "environment": ["environment"],
    "water": ["construction_infrastructure", "environment"],
    "energy": ["industry_energy_utilities"],
    "facilities": ["industry_energy_utilities"],
    "cold_chain": ["industry_energy_utilities", "ports_logistics"],
    "fleet": [
...
def list_kits(*, include_standby: bool = False) -> list[dict]:
    ...
    return [
        kit for kit in SOLUTION_KITS if kit.get("availability", "active") == "active"
    ]
...
def kit_public_sectors(kit: dict) -> list[str]:
    """Map an internal kit use-case to the six public sector identifiers."""

    industry = str(kit.get("industry", ""))
    try:
        return list(_PUBLIC_SECTORS_BY_INDUSTRY[industry])
    except KeyError as exc:
        raise ValueError(
            f"IoT kit industry has no public sector mapping: {industry}"
        ) from exc
