...
class EventNames:
    ...
    INTELLIGENCE_ACQUISITION_REQUESTED = "intelligence.acquisition_requested"
    INTELLIGENCE_ACQUISITION_FAILED = "intelligence.acquisition_failed"
    SATELLITE_ACQUISITION_COMPLETED = "satellite.acquisition_completed"
    WEATHER_ACQUISITION_COMPLETED = "weather.acquisition_completed"
