"""HTTP response contracts for Agriculture intelligence."""
...
class AgricultureEvaluationOut(BaseModel):
    asset_id: str
...
class AgricultureMapLayersOut(BaseModel):
    asset_id: str
    items: list[dict[str, Any]]
    total: int


class AgricultureReportContextOut(BaseModel):
