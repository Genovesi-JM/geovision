...
def upgrade() -> None:
    ...
    op.add_column('orders', sa.Column('payment_intent_id', sa.String(length=36), nullable=True))
    ...
    op.add_column('orders', sa.Column('assigned_team', sa.String(length=100), nullable=True))
    op.add_column('orders', sa.Column('scheduled_start', sa.DateTime(), nullable=True))
    op.add_column('orders', sa.Column('scheduled_end', sa.DateTime(), nullable=True))
    op.add_column('orders', sa.Column('actual_start', sa.DateTime(), nullable=True))
    op.add_column('orders', sa.Column('actual_end', sa.DateTime(), nullable=True))
    ...
    op.add_column('orders', sa.Column('billing_info_json', sa.Text(), nullable=True))
    ...
    op.add_column('orders', sa.Column('metadata_json', sa.Text(), nullable=True))
