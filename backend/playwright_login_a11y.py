...
Runs headless Chromium, navigates to /login.html, submits an operator-selected
local account, waits for #success-box, injects axe-core from CDN and runs
...
Exit code: 0 = success (no violations), 2 = missing inputs or axe violations,
1 = other error.
"""
