...
PHASE_16_OPENAPI_SHA256 = "111441482cb967ff8807f672c6dc9b6faf7a8cba93cad45c25618f7b934aa715"
...
def test_openapi_contract_is_byte_stable(client):
    ...
    assert hashlib.sha256(payload).hexdigest() == PHASE_16_OPENAPI_SHA256
