...
PHASE_13_OPENAPI_SHA256 = "60fdb214ad0836a3555dcc18f99cb751a11852c80fdeba7860615fb2f4b6b2a7"
...
def test_openapi_contract_is_byte_stable(client):
    payload = json.dumps(
        client.app.openapi(),
        sort_keys=True,
        separators=(",", ":"),
    ).encode()
    assert hashlib.sha256(payload).hexdigest() == PHASE_13_OPENAPI_SHA256
