...
PHASE_14_OPENAPI_SHA256 = "772cd3283dec244270808e17ac8b6e6623c552d374c54ef7aa39bd406019b8a3"
...
def test_openapi_contract_is_byte_stable(client):
    ...
    assert hashlib.sha256(payload).hexdigest() == PHASE_14_OPENAPI_SHA256
