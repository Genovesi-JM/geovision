...
PHASE_15_OPENAPI_SHA256 = "05902cf5e9ac5a6236ac0e56df235665c787f4b4d0915149bb075093ca7fdaed"
...
def test_openapi_contract_is_byte_stable(client):
    ...
    assert hashlib.sha256(payload).hexdigest() == PHASE_15_OPENAPI_SHA256
