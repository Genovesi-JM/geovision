...
PHASE_10_OPENAPI_SHA256 = "bf2e0bcb4465f13d0cfce63f9768d7e1417b027733148ca402b378d0d346e18f"
...
def test_openapi_contract_is_byte_stable(client):
    ...
    assert hashlib.sha256(payload).hexdigest() == PHASE_10_OPENAPI_SHA256
