...
PHASE_25_OPENAPI_SHA256 = "417fe40098a198b7c68c5ebaaf6814f8a3c420f59f4098aba4c9bc2aea0d3d6b"
...
def test_phase_25_openapi_contract_is_byte_stable(client):
    payload = json.dumps(
        client.app.openapi(),
        sort_keys=True,
        separators=(",", ":"),
    ).encode()
    assert hashlib.sha256(payload).hexdigest() == PHASE_25_OPENAPI_SHA256
